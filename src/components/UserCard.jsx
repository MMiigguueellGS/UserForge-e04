    ...
    <div className="w-[270px] max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 drop-shadow-md p-2 hover:scale-110 ">
      <div className="flex flex-col items-center p-4">
        ...
        <section className="grid w-full border-b-2 border-[#E5E5E5]  border-t-2 py-4    ">
          ...
          <span className="text-sm text-gray-500 dark:text-gray-400 mb-3  font-semibold">
            {user.email}
          </span>

          <span className="text-sm text-black">CUMPPLEAÑOS</span>
          <span className="text-sm text-gray-500 dark:text-gray-400 flex items-center font-semibold">
            <i className="bx bxs-cake pr-2 text-xl "></i>
            {user.birthday ? user.birthday : "No se ingreso"}
          </span>
        </section>
        ...
        <div className="flex mt-4 space-x-3 md:mt-6 ">
          ...
          >
            <i className="bx bxs-edit-alt text-[#D3D3D3] text-2xl"></i>
          </button>
        </div>
      </div>
    </div>
